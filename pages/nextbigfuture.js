...
// Initial News source
const defaultNewsSource = 'next-big-future';
    ...
    return (
      <div>
        ...
        <ul className="newsMenu">
          <li><a href="#" onClick={this.searchNewsAPI} name="top-headlines?country=ie&category=technology">Technology News Ireland</a></li>
          <li><a href="#" onClick={this.searchNewsAPI} name="top-headlines?country=gb&category=technology">Technology News UK</a></li>
          <li><a href="#" onClick={this.searchNewsAPI} name="top-headlines?country=us&category=technology">Technology News US</a></li>
        </ul>
